...
const navAdmin = [
  { name: 'Panel Admin', path: '/panel-admin' }
];
...
<template>
  ...
  <header class="header">
    ...
    <div class="header-container">
      ...
      >
        <img
            src="../assets/img/img_iconos/favicon.png"
            alt="Logo"
            class="logo"
        >
        ...
        >
          ...
          <div class="profile-wrapper">
            ...
            >
              ...
              <button
                  class="dropdown-item-custom logout-item"
                  @click="salir"
              >
                Salir
              </button>
